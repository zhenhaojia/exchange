  ...
  try {
    ...
    const books = [
      ...
      },
      {
        ...
        images: JSON.stringify(['https://via.placeholder.com/300x400/795548/ffffff?text=高等数学'])
      },
      {
        title: '设计中的设计',
        author: '原研哉',
        ...
        location: '上海市徐汇区',
        delivery_methods: JSON.stringify(['快递', '同城面交']),
        images: JSON.stringify(['https://via.placeholder.com/300x400/009688/ffffff?text=设计中的设计'])
      },
      {
        title: '万历十五年',
        author: '黄仁宇',
        ...
        location: '成都市武侯区',
        delivery_methods: JSON.stringify(['快递', '邮寄']),
        images: JSON.stringify(['https://via.placeholder.com/300x400/FFC107/000000?text=万历十五年'])
      },
      {
        title: '小王子',
        author: '安托万·德·圣埃克苏佩里',
        ...
        location: '西安市雁塔区',
        delivery_methods: JSON.stringify(['快递', '同城面交', '邮寄']),
        images: JSON.stringify(['https://via.placeholder.com/300x400/E91E63/ffffff?text=小王子'])
      },
      {
        ...
        location: '南京市鼓楼区',
        delivery_methods: JSON.stringify(['快递', '同城面交']),
        images: JSON.stringify(['https://via.placeholder.com/300x400/3F51B5/ffffff?text=六级词汇'])
      }
    ];
